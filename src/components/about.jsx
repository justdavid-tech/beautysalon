    ...
    <div className="w-full bg-white text-gray-800">
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            { name: "Zubby", role: "Founder & Lead Stylist", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
            { name: "Sarah", role: "Makeup Artist", img: "https://images.unsplash.com/photo-1595152452543-e5fc28ebc2b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
            { name: "Jessica", role: "Hair Specialist", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
            { name: "Amara", role: "Nail Technician", img: "https://images.unsplash.com/photo-1607746882042-944635dfe10e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
          ].map((member) => (
